defmodule Kite.User_ProfileTest do
  ...
  describe "margins_equity" do
    ...
    test "update_margins__equity/2 with valid data updates the margins__equity" do
      ...
      assert {:ok, %Margins_Equity{} = margins__equity} = User__profile.update_margins__equity(margins__equity, update_attrs)
    ...
    test "update_margins__equity/2 with invalid data returns error changeset" do
      margins__equity = margins__equity_fixture()
      assert {:error, %Ecto.Changeset{}} = User__profile.update_margins__equity(margins__equity, @invalid_attrs)
    ...
    test "delete_margins__equity/1 deletes the margins__equity" do
      ...
      assert_raise Ecto.NoResultsError, fn -> User__profile.get_margins__equity!(margins__equity.id) end
    end
  ...
  describe "margins_commodity" do
    ...
    test "create_margins__commodity/1 with valid data creates a margins__commodity" do
      ...
      assert {:ok, %Margins_Commodity{} = margins__commodity} = User__profile.create_margins__commodity(valid_attrs)
    ...
    test "update_margins__commodity/2 with valid data updates the margins__commodity" do
      ...
      assert {:ok, %Margins_Commodity{} = margins__commodity} = User__profile.update_margins__commodity(margins__commodity, update_attrs)
    ...
    test "update_margins__commodity/2 with invalid data returns error changeset" do
      margins__commodity = margins__commodity_fixture()
      assert {:error, %Ecto.Changeset{}} = User__profile.update_margins__commodity(margins__commodity, @invalid_attrs)
    ...
    test "delete_margins__commodity/1 deletes the margins__commodity" do
      margins__commodity = margins__commodity_fixture()
      assert {:ok, %Margins_Commodity{}} = User__profile.delete_margins__commodity(margins__commodity)
      assert_raise Ecto.NoResultsError, fn -> User__profile.get_margins__commodity!(margins__commodity.id) end
    end
